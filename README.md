...
Code and some data related this article will be provided here soon. Our code is written in tensorflow library. In the code, minor things are omitted for simplicity. Data are composed of 2D flow fields including du/dy, dw/dy, dT/dy, and p.
