...
Code related to our article is given in 'Code example.py'. Our code is written in tensorflow library with version 1.4.X If you use tensorflow version 2.0, see <https://www.tensorflow.org/guide/migrate>. In our code, minor things are omitted for simplicity. The example network is composed of three 3x3 convolution layers and one 11x11 convolution layer.
