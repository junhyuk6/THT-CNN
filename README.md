...
Some data, 250 instantaneous flow fields, are compressed into ten zip files, and given here. The file number gap, 4, is corresponded to 36 in wall time unit. Each file is composed of 2D (192x192 size) flow fields including du/dy, dw/dy, p, and dT/dy. In the given data, the mean values of input data are subtracted, and they are 180 (of du/dy), 0 (of dw/dy), and 0 (of p), respectively. That of dT/dy is not subtracted. Root-mean-square values of given data are approximately 66.3 (of du/dy), 37.0 (of dw/dy), and 1.58 (of p), respectively.
